...
chcp 1252 >nul 2>&1
title SwitchBros_BasisPaket v135
...
echo.
echo      Wenn du dieses Skript (SwitchBros-BasisPaket.bat) von deiner SD-Karte aus gestartet hast, dann
...
if exist "%sd%:\switchbros" (
	attrib -A -R /S /D %sd%:\switchbros\*
	attrib -A -R %sd%:\switchbros)
