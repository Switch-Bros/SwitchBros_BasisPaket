...
echo.
echo -----------------------------------------------------------------------------------------------------
echo     Achtung Modchip Besitzer = LAKKA und die Ubuntu Bionic Distro werden jetzt unterstuetzt^^!
echo.
...
echo.
echo     W = BITTE eingeben um fortzufahren wenn System(e) installiert wurden^^!
echo.
echo -----------------------------------------------------------------------------------------------------
